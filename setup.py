...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-discount_formula',
    download_url='https://github.com:nantic/trytond-discount_formula.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-discount_formula.git'
    },
    classifiers=[
